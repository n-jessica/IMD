...
public class ProgramaFuncaoQuadrado {
     ...
     * 
     * Esse programa declara uma função chamada quadrado, que, dado um número, 
     * retorna o valor desse número multiplicado por ele mesmo, ou seja, esse número elevado ao quadrado.
     */
